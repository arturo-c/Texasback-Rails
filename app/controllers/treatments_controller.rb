class TreatmentsController < ApplicationController
  ...
  def index
    @treatments_page = Page.find_by_url('/treatments', true) #finds the live treatments page        
  ...
  protected
    ...
    def set_radiant_layout
      @content_for_header_content = header_content_for_page('treatments')
      @content_for_body_class = body_class_for_page('treatments')
      @content_for_title_tag = title_tag_for_page('treatments')
